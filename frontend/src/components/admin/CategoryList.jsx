        ...
        return (
          <div>
            ...
            <button
              ...
              onClick={() => onViewDetails(originalCategory)}
            >
              Details
            </button>
            <button
              ...
              onClick={() => {
                setSelectedCategoryId(originalCategory.id);
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            This action will permanently delete the selected category.
            <br />
